...
ifeq ($(BR2_PACKAGE_LINUX_FIRMWARE_OPENIPC_RTL_8188FU),y)
define LINUX_FIRMWARE_OPENIPC_INSTALL_REALTEK_FU
	$(INSTALL) -m 755 -d $(TARGET_DIR)/lib/firmware/rtlwifi
	$(INSTALL) -m 644 -t $(TARGET_DIR)/lib/firmware/rtlwifi $(LINUX_FIRMWARE_OPENIPC_PKGDIR)/files/rtlwifi/rtl8188fufw.bin
endef
endif
...
define LINUX_FIRMWARE_OPENIPC_INSTALL_TARGET_CMDS
	...
	$(LINUX_FIRMWARE_OPENIPC_INSTALL_REALTEK_FU)
