...
#
# webrtc-audio-processing-openipc — webrtc-audio-processing-openipc Buildroot package
#
################################################################################
...
WEBRTC_AUDIO_PROCESSING_OPENIPC_SITE = http://distributions.freedesktop.org/software/pulseaudio/webrtc-audio-processing
