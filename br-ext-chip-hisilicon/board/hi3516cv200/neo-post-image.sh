#!/bin/sh
# Post-image: append cv200 DTB to zImage and wrap as uImage for hi3516cv200_neo.
...
DTB="$KDIR/arch/arm/boot/dts/hisilicon/hi3516cv200-demb.dtb"
LOADADDR=0x80008000
